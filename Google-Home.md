...
## Get started  
The first step is to add [Emby with Google Home](Google%20Home#emby-with-google-home) to your Google Home account. Once this is done, you will need [Emby Connect](Emby%20Connect) to link your Emby account to Google Home. Emby with Google Home also requires [Emby premiere](https://emby.media/premiere.html). 
